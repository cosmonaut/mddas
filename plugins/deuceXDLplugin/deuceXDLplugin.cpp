/* Author: Nicholas Nell
   ...
   Sampling thread for the deuceXDLplugin detector. 
*/
...
DEUCEXDLplugin::DEUCEXDLplugin() : SamplingThreadPlugin() {
...
//        }
        ...
        for(int i {}; i < 1000; i++)
        {
            v.append(MDDASDataPoint(rand() % 10000,rand() % 10000,i));
        }
...
Q_EXPORT_PLUGIN2(deucexdlplugin, DEUCEXDLplugin);
